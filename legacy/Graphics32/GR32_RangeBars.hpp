...
// (DO NOT EDIT: machine generated header) 'Gr32_rangebars.pas' rev: 21.00
...
protected:
	...
	virtual Types::TRect __fastcall GetHandleRect(void);
	int __fastcall GetButtonSize(void);
	Types::TRect __fastcall GetTrackBoundary(void);
