...
#ifndef MONOTCUBICINTERPOLATORH
#define MONOTCUBICINTERPOLATORH
//---------------------------------------------------------------------------
 ...
 MonotCubicInterpolator(const char* datafilename)
   ...
   */
   ...
   /**
      ...
      @param f array of corresponding f values
      @param size number of samples in f and x

      Accepts two equal-length arrays as input for constructing
   ...
   */
   ...
   /**
      @param xinterval x values spacing
      @param f array of corresponding f values
      @param size number of samples in f
