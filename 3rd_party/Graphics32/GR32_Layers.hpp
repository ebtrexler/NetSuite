...
// (DO NOT EDIT: machine generated header) 'Gr32_layers.pas' rev: 21.00
...
#pragma option push -b-
enum Gr32_layers__6 { roProportional, roConstrained };
#pragma option pop

typedef Set<Gr32_layers__6, roProportional, roConstrained>  TRBOptions;
...
protected:
	...
	virtual void __fastcall DoConstrain(Gr32::TFloatRect &OldLocation, Gr32::TFloatRect &NewLocation, TDragState DragState, Classes::TShiftState Shift);
	virtual void __fastcall DoSetLocation(const Gr32::TFloatRect &NewLocation);
