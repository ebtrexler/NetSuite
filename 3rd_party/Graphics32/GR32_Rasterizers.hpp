...
// (DO NOT EDIT: machine generated header) 'Gr32_rasterizers.pas' rev: 21.00
...
protected:
	...
	virtual void __fastcall DoRasterize(Gr32::TCustomBitmap32* Dst, const Types::TRect &DstRect) = 0 ;
...
public:
	...
	void __fastcall Rasterize(Gr32::TCustomBitmap32* Dst, const Types::TRect &DstRect)/* overload */;
	void __fastcall Rasterize(Gr32::TCustomBitmap32* Dst, const Types::TRect &DstRect, const TCombineInfo &CombineInfo)/* overload */;
	void __fastcall Rasterize(Gr32::TCustomBitmap32* Dst, const Types::TRect &DstRect, Gr32::TCustomBitmap32* Src)/* overload */;
...
protected:
	virtual void __fastcall DoRasterize(Gr32::TCustomBitmap32* Dst, const Types::TRect &DstRect);
...
extern PACKAGE TRasterizerClass DefaultRasterizerClass;
extern PACKAGE int NumberOfProcessors;
extern PACKAGE TCombineInfo __fastcall CombineInfo(Gr32::TCustomBitmap32* Bitmap);
