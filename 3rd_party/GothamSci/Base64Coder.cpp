...
unsigned long Base64Coder::Encode(const PBYTE pBuffer, DWORD nBufLen)
{
...
unsigned long Base64Coder::Encode(LPCSTR szMessage)
{
	if(szMessage != NULL)
		return Base64Coder::Encode((const PBYTE)szMessage, strlen(szMessage));
   else return 0;
}

unsigned long Base64Coder::Decode(const PBYTE pBuffer, DWORD dwBufLen)
{
...
unsigned long Base64Coder::Decode(LPCSTR szMessage)
{
	if(szMessage != NULL)
		return Base64Coder::Decode((const PBYTE)szMessage, strlen(szMessage));
   else return 0;
}
